...
//This code copy from https://opensource.apple.com/source/CommonCrypto/CommonCrypto-55010/Source/RC2/rc2.c.auto.html
...
void rc2_keygen(unsigned short xkey[64], const unsigned char* key, unsigned len, unsigned bits)
{
	...
	i = 128 - len;
	x = PITABLE[((unsigned char*)xkey)[i] & (255 >> (7 & (0 - bits)))]; // (255 >> (7 & -bits) = TM, TM = 255 MOD 2^(8 + T1 - 8*T8);
